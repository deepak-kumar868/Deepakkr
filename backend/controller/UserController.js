...
exports.deleteCertificate = async (req, res) => {
    try {
        ...
        const certi = user.certificate.find((item) => item._id == id);

        await cloudinary.v2.uploader.destroy(certi.image.public_id);


        user.certificate = user.certificate.filter((item) => item._id != id);
